    ...
    <div>
      <div>
        ...
        <p className='text-center px-12 w-11/12 pb-4'>Vel risus commodo viverra maecenas accumsan lacus vel facilisis.
             ...
             <div className='grid grid-cols-3 px-4 pt-6 gap-4'>
                {
                    datas.map(data =>(
                        ...
                        <p className='pt-2 pb-4'>{data.p}</p>
                        ...
                        <div className='pt-8 '>
                          <button className=' text-lime-900 font-bold rounded-md border-2 px-2 hover:bg-lime-800'>select plan</button>
                          </div>
                        </div>
                    ))
                }
